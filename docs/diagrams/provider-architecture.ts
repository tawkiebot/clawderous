...
/**
 * Clawderous Provider Architecture Diagram
 * 
 * To view/edit this diagram:
 * 1. Run `npm run dev` in the arc editor
 * 2. Or use the ArcDiagram React component below
 */
const providerArchitecture: ArcDiagramData = {
