...
import { ProviderDiagram } from './pages/ProviderDiagram'
  ...
  return (
    <nav>
      ...
      <ul className="nav-links">
        ...
        <li><Link to="/providers" className={location.pathname === '/providers' ? 'active' : ''}>Providers</Link></li>
  ...
  return (
    <BrowserRouter basename="/clawderous">
      ...
      <Routes>
        ...
        <Route path="/providers" element={<ProviderDiagram />} />
      </Routes>
      <Footer />
    </BrowserRouter>
  )
